...
namespace UnityExtensions.Memo {
    ...
    internal static class SceneMemoHelper {

        public static SceneMemoSaveData Data;
        public static SceneMemoHierarchyWindow PopupWindowContent;

        public static void Initialize() {
            Data = MemoFileUtility.LoadUnitySceneMemoData();

            if( Data != null ) {
                PopupWindowContent = new SceneMemoHierarchyWindow();
        ...
        public static SceneMemo GetMemo( GameObject obj, int localIdentifier = 0 ) {
            if ( Data == null )
                return null;
        ...
        public static SceneMemo GetMemo( string scenePath, int localIdentifier ) {
            if ( Data == null )
                return null;
        ...
        public static void RemoveMemo( SceneMemo memo ) {
            if ( Data == null )
                return;
        ...
        private static SceneMemoScene GetSceneMemo( string path ) {
            if ( Data == null )
                return null;
