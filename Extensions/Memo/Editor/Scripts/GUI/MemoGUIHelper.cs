...
namespace UnityExtensions.Memo {
    ...
    internal static class MemoGUIHelper {

        public static string[] LabelMenu     = { "默认", "红色", "绿色", "青色", "黄色", "紫色" };
        public static string[] TextColorMenu = { "黑色", "白色" };
        ...
        public static class Styles {
            ...
            static Styles() {
                ...
                MemoLabel = new GUIStyle( GUI.skin.label ) {
                    wordWrap = true,
                    richText = true,
                    fontSize = EditorMemoPrefs.UnityEditorMemoFontSize,
                };
        ...
        public static class Textures {
            ...
            static Textures() {
                var guiDir = MemoFileUtility.GUIDirectoryPath;
