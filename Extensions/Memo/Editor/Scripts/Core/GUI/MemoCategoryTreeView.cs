...
namespace UnityExtensions.Memo {
    ...
    internal class MemoCategoryWindowTreeView : TreeView {

        public event Action<MemoCategory> OnContextClick;
        public event Action<List<MemoCategory>> OnCategoryOrderChanged;

        private List<MemoCategory> category;

        public MemoCategoryWindowTreeView( TreeViewState treeViewState, List<MemoCategory> category ) : base( treeViewState ) {
        ...
        public void BeginRename( MemoCategory rename ) {
        ...
        public void OnDropDraggedElementsAtIndex( List<TreeViewItem> draggedRows, TreeViewItem parent, int insertIndex ) {
            ...
            var newCategory = new List<MemoCategory>();
