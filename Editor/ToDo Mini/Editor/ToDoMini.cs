...
namespace ToDoMini
{
    public class ToDoMini : EditorWindow
    {
            ...
            get
            {
                if (dataHolder == null || shouldRefreshData)
                {
                    ToDoMiniData testDataHolder =
                        AssetDatabase.LoadAssetAtPath(dataPath, typeof(ToDoMiniData)) as ToDoMiniData;
        ...
        readonly string dataPath = "Packages/com.lone.unityextensions/Editor/ToDo Mini/ToDoMini data.asset";
